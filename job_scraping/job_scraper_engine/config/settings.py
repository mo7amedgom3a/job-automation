...
class SiteConfig:
    ...
    max_pages: int = 0
    # Proxy list (optional); empty = no proxy
...
SITES: list[SiteConfig] = [
    ...
    SiteConfig(
        name="indeed_eg",
        start_urls=["https://eg.indeed.com/jobs?q=%22software+engineer%22+OR+backend+OR+DevOps+OR+AWS+OR+Cloud+OR+python+OR+Golang&l=Cairo&fromage=1&from=searchOnDesktopSerp&vjk=f435c7d4d7719dcd"],
        fetcher="stealth",
        download_delay=3.0,
        robots_txt_obey=False,
        next_page_selector="a[aria-label='Next Page']::attr(href)",
    ...
    SiteConfig(
        name="indeed_ae",
        start_urls=["https://ae.indeed.com/jobs?q=%22Software+Engineer%22+OR+backend+OR+DevOps+OR+AWS+OR+cloud+OR+Python+OR+%22FUll+Stack%22&l=&fromage=1&from=searchOnDesktopSerp&vjk=90b7ff2ca1a35511"],
        fetcher="stealth",
        download_delay=3.0,
        robots_txt_obey=False,
        next_page_selector="a[aria-label='Next Page']::attr(href)",
...
DEDUP_WINDOW_HOURS: int = 24          # ignore jobs seen within this window
